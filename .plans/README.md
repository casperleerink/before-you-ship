...
Proposed improvements to the codebase, organized by type and priority.
...
| # | Plan | Priority | Effort |
|---|------|----------|--------|
| 004 | [Extract ConversationStatusDropdown](./004-refactor-conversation-status-dropdown.md) | Medium | Small |
| 005 | [Extract auth + membership guard helper](./005-refactor-auth-membership-helper.md) | Medium | Medium |
| 006 | [Centralize date formatting utilities](./006-refactor-centralize-date-utils.md) | Low | Small |

## New Features

| # | Plan | Priority | Effort |
|---|------|----------|--------|
| 007 | [Project deletion with cascading cleanup](./007-feature-project-deletion.md) | Medium | Medium |
